...
{
    public class LinuxVersionInfoTests
    {
        [Fact]
        ...
        public void DebianTest()
        {
            ...
            linuxVersion.VERSION.Should().Be("10 (buster)");
            ...
            linuxVersion.SUPPORT_URL.Should().Be("https://www.debian.org/support");
        ...
        public void UbuntuTest()
        {
            ...
            linuxVersion.SUPPORT_URL.Should().Be("https://help.ubuntu.com/");
